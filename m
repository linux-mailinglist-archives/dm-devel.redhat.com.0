...
Received: from us-smtp-delivery-1.mimecast.com (us-smtp-delivery-1.mimecast.com [205.139.110.120])
	by mail.lfdr.de (Postfix) with ESMTP id 50B7715C0FF
	for <lists+dm-devel@lfdr.de>; Thu, 13 Feb 2020 16:06:10 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1581606369;
	h=from:from:sender:sender:reply-to:subject:subject:date:date:
	 message-id:message-id:to:to:cc:cc:mime-version:mime-version:
	 content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:list-id:list-help:
	 list-unsubscribe:list-subscribe:list-post;
	bh=jaIq381LnkmRQo1PlU2eMtiS93sO+JuLmQ/0OAwCBxA=;
	b=KcfX5lqpVAP3b+lHQOozlpfNrVOm8NvKcxcjjFxHjqVDi6rBwQ4VO26v/49AQdUeBBmYRK
	cly9/FJQhK8IVCUk1fvbLBLeleSWx66rIwFAPnjUPvJMaTM2Cr+v1oBsHs2QYWlfs5CblL
	sc4eI+qzEEd+xwAMDT95ozr6yIWquCo=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-274-4emzlYHhNC-MeRUkBXqt4g-1; Thu, 13 Feb 2020 10:06:04 -0500
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.phx2.redhat.com [10.5.11.15])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 2E4368018A3;
	Thu, 13 Feb 2020 15:05:56 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.20])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 5EC9F5C11E;
	Thu, 13 Feb 2020 15:05:49 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id D75EB18089CD;
	Thu, 13 Feb 2020 15:05:35 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com
	[10.5.11.23])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 01DF5IMK013068 for <dm-devel@listman.util.phx.redhat.com>;
	Thu, 13 Feb 2020 10:05:18 -0500
Received: by smtp.corp.redhat.com (Postfix)
	id CC8E126FB9; Thu, 13 Feb 2020 15:05:18 +0000 (UTC)
Delivered-To: dm-devel@redhat.com
Received: from o.ww.redhat.com (ovpn-117-113.ams2.redhat.com [10.36.117.113])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 98D9526FAA;
	Thu, 13 Feb 2020 15:05:11 +0000 (UTC)
From: heinzm@redhat.com
To: dm-devel@redhat.com
Date: Thu, 13 Feb 2020 16:05:11 +0100
Message-Id: <c45a7ce7805c70c6d62d2becef92ba0fceaa971b.1581606073.git.heinzm@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 2.84 on 10.5.11.23
X-loop: dm-devel@redhat.com
Cc: awalsh@redhat.com, msnitzer@redhat.com, corwin@redhat.com,
	jdorminy@redhat.com
Subject: [dm-devel] [PATCH v2] dm ebs: new block size emulating target
...
X-MC-Unique: 4emzlYHhNC-MeRUkBXqt4g-1
...
Changes versus version 1 sent on 2/10/2020:
- allow larger underlying block size
- prefetch buffers for mis-aligned writes
...
---
 ...
 drivers/md/dm-ebs-target.c                    | 425 ++++++++++++++++++
...
new file mode 100644
index 000000000000..1439bcece6fd
--- /dev/null
...
+				dm_bufio_prefetch(ec->bufio, __sector_to_block(ec, bio->bi_iter.bi_sector), 1);
+			if (__block_mod(bio_end_sector(bio), ec->ubs))
+				dm_bufio_prefetch(ec->bufio, __sector_to_block(ec, bio_end_sector(bio)), 1);
+		}
+	}
+
+	bio_list_for_each(bio, &bios) {
