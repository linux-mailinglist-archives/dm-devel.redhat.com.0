...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B4A864DDDB
	for <lists+dm-devel@lfdr.de>; Thu, 15 Dec 2022 16:33:53 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1671118432;
	...
	bh=c7zTcRRwRMOESumPGsqCYmGg5d7rmN7c63q/RwZtkqM=;
	b=UJWssL10vi7GThUJwc0HQoEx+C3vlga05Wydr7bW1gV5KT2IZMgSADhsVdcCMzd9KwGcG+
	rHYiJb0PgSGKM7Cn2OUrEzAoSGNAjIHOG5nWV2X1sjZBgFOJ4j4vqdf93sNz+PViEryvZk
	7xNToldteSBCR08RA4icN+G8NQqszOc=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-134-R2EEJqWnMn2E9CcIgahHrw-1; Thu, 15 Dec 2022 10:33:42 -0500
X-MC-Unique: R2EEJqWnMn2E9CcIgahHrw-1
Received: from smtp.corp.redhat.com (int-mx06.intmail.prod.int.rdu2.redhat.com [10.11.54.6])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id ADD2A85D061;
	Thu, 15 Dec 2022 15:33:39 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com [10.30.29.100])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 6BC302166B26;
	Thu, 15 Dec 2022 15:33:38 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (localhost [IPv6:::1])
	by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with ESMTP id CB9681946A6C;
	Thu, 15 Dec 2022 15:33:37 +0000 (UTC)
X-Original-To: dm-devel@listman.corp.redhat.com
Delivered-To: dm-devel@listman.corp.redhat.com
Received: from smtp.corp.redhat.com (int-mx10.intmail.prod.int.rdu2.redhat.com
 [10.11.54.10])
 by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with
 ESMTP id 4C98219465B2
 for <dm-devel@listman.corp.redhat.com>; Thu, 15 Dec 2022 15:33:35 +0000 (UTC)
Received: by smtp.corp.redhat.com (Postfix)
 id 0DD70400F5A; Thu, 15 Dec 2022 15:33:35 +0000 (UTC)
Delivered-To: dm-devel@redhat.com
Received: from octiron.msp.redhat.com (octiron.msp.redhat.com [10.15.80.209])
 by smtp.corp.redhat.com (Postfix) with ESMTPS id EB1BD49BB6A;
 Thu, 15 Dec 2022 15:33:34 +0000 (UTC)
Received: from octiron.msp.redhat.com (localhost.localdomain [127.0.0.1])
 by octiron.msp.redhat.com (8.14.9/8.14.9) with ESMTP id 2BFFXXss020724;
 Thu, 15 Dec 2022 09:33:33 -0600
Received: (from bmarzins@localhost)
 by octiron.msp.redhat.com (8.14.9/8.14.9/Submit) id 2BFFXXf4020723;
 Thu, 15 Dec 2022 09:33:33 -0600
Date: Thu, 15 Dec 2022 09:33:32 -0600
From: Benjamin Marzinski <bmarzins@redhat.com>
To: Martin Wilck <martin.wilck@suse.com>
Message-ID: <20221215153332.GF6245@octiron.msp.redhat.com>
...
> > > and
> > > hardware_handler.=A0 These three strings all have argument counts, an=
d
...
static const char * const ptr1 =3D "test";
static const char * const ptr2 =3D "test";
static const char arr1[] =3D "test";
static const char arr2[] =3D "test";

printf("pointers are %s\n", (ptr1 =3D=3D ptr2) ?  "equal" : "not equal");
printf("arrays are %s\n", (arr1 =3D=3D arr2) ?  "equal" : "not equal");
