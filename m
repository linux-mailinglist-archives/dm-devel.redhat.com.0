...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	by mail.lfdr.de (Postfix) with ESMTPS id B063E7A0E15
	for <lists+dm-devel@lfdr.de>; Thu, 14 Sep 2023 21:19:03 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1694719142;
	...
	bh=OsBa1H8d8CWTrm5U5JqIFktxJ4ZQD8zAbDy59LMu0Bs=;
	b=HjJk9pt9qi63y7DDXuG2WzUxRIE7tCmKVXQV2jHW+puDgNlOMsDgMK9QoCkP5nEx93Eeyh
	4suwhM+S5q5yg1asEI8QcOcwtQhrYeKOnAI7jdA3c+02eycHr42nMWa5y94gB7NUEcB5Vl
	JkNkHF+9x0BmxYOTToyjxGiG2Szrc9E=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-206-6l3ZmvqvPPmH8tWejqi28w-1; Thu, 14 Sep 2023 15:18:54 -0400
X-MC-Unique: 6l3ZmvqvPPmH8tWejqi28w-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.rdu2.redhat.com [10.11.54.3])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 6E6E9101B456;
	Thu, 14 Sep 2023 19:18:51 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com [10.30.29.100])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 55EA41054FC2;
	Thu, 14 Sep 2023 19:18:51 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (localhost [IPv6:::1])
	by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with ESMTP id F34D319451DB;
...
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.rdu2.redhat.com
 ...
 ESMTP id 45A9819452F0
 for <dm-devel@listman.corp.redhat.com>; Thu, 14 Sep 2023 19:17:31 +0000 (UTC)
Received: by smtp.corp.redhat.com (Postfix)
 id 365F4406AA66; Thu, 14 Sep 2023 19:17:31 +0000 (UTC)
Delivered-To: dm-devel@redhat.com
Received: from mimecast-mx02.redhat.com
 (mimecast03.extmail.prod.ext.rdu2.redhat.com [10.11.55.19])
 by smtp.corp.redhat.com (Postfix) with ESMTPS id 2DBFD40C2070
 for <dm-devel@redhat.com>; Thu, 14 Sep 2023 19:17:31 +0000 (UTC)
Received: from us-smtp-inbound-delivery-1.mimecast.com
 (us-smtp-delivery-1.mimecast.com [205.139.110.120])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 042AB88B7A8
 for <dm-devel@redhat.com>; Thu, 14 Sep 2023 19:17:31 +0000 (UTC)
Received: from mail-qk1-f178.google.com (mail-qk1-f178.google.com
 [209.85.222.178]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-490-k74AjtkVOhmg_8nuhwhRSg-2; Thu, 14 Sep 2023 15:17:29 -0400
X-MC-Unique: k74AjtkVOhmg_8nuhwhRSg-2
Received: by mail-qk1-f178.google.com with SMTP id
 af79cd13be357-76ee895a3cbso87905985a.0
 for <dm-devel@redhat.com>; Thu, 14 Sep 2023 12:17:28 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1694719048; x=1695323848;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=VswPob6lEXP4mClptnd8WzZFmIfNb1rB/+nEAF40UAo=;
 b=
X-Gm-Message-State: AOJu0YyNMcl/cLwdlM0zp6x3e9KaOOtAnpLFJaE0DqtxTBd4nFX0028Y
 bIj9x0KNGeQ7Juv92Rg4lFhdIqt4SC97UFaPfYS/buJUar8Yh8VYL6DWeWlE00guQ+PdVr8GsU6
 pMgIIeDRVMYMELdS3EntZGLtKPWXaroB88W1jMej4nF8tEKuZ+t3W05Q/H6nXLxxHJ6M9RIMT
X-Google-Smtp-Source: AGHT+IH/VfC9G8FRRUTXA8IFb77AINLpvUqrela9Z5ZtHq3uYzMsBB5emyJaSKA/xgfQW9NYXnGY5Q==
X-Received: by 2002:a05:620a:c10:b0:76c:8998:1866 with SMTP id
 l16-20020a05620a0c1000b0076c89981866mr5487883qki.40.1694719046546; 
 Thu, 14 Sep 2023 12:17:26 -0700 (PDT)
Received: from localhost (pool-68-160-141-91.bstnma.fios.verizon.net.
 [68.160.141.91]) by smtp.gmail.com with ESMTPSA id
 cx21-20020a05620a51d500b0076d74da4481sm676645qkb.23.2023.09.14.12.17.25
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 14 Sep 2023 12:17:26 -0700 (PDT)
From: Mike Snitzer <snitzer@kernel.org>
To: dm-devel@redhat.com
Date: Thu, 14 Sep 2023 15:16:21 -0400
Message-Id: <20230914191635.39805-26-snitzer@kernel.org>
In-Reply-To: <20230914191635.39805-1-snitzer@kernel.org>
References: <20230914191635.39805-1-snitzer@kernel.org>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 3.1 on 10.11.54.1
Subject: [dm-devel] [PATCH v3 25/39] dm vdo: add slab structure,
 slab journal and reference counters
...
three sections. Most of a slab consists of a linear sequence of 4K
blocks. These blocks are used either to store data, or to hold
portions of the block map (see subsequent patches). In addition to the
data blocks, each slab has a set of reference counters, using 1 byte
for each data block. Finally each slab has a journal. Reference
updates are written to the slab journal, which is written out one
block at a time as each block fills. A copy of the reference counters
is kept in memory, and are written out a block at a time, in
oldest-dirtied-order whenever there is a need to reclaim slab journal
space. The journal is used both to ensure that the main recovery
journal (see subsequent patches) can regularly free up space, and also
to amortize the cost of updating individual reference blocks.
