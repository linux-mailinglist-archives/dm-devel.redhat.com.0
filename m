...
Received: from mx1.redhat.com (mx1.redhat.com [209.132.183.28])
	by mail.lfdr.de (Postfix) with ESMTPS id 3AA483B022
	for <lists+dm-devel@lfdr.de>; Mon, 10 Jun 2019 09:59:55 +0200 (CEST)
Received: from smtp.corp.redhat.com (int-mx06.intmail.prod.int.phx2.redhat.com [10.5.11.16])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mx1.redhat.com (Postfix) with ESMTPS id 42E873086258;
	Mon, 10 Jun 2019 07:59:48 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.20])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 0764E61479;
	Mon, 10 Jun 2019 07:59:47 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id CEDC11806B15;
	Mon, 10 Jun 2019 07:59:44 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx06.intmail.prod.int.phx2.redhat.com
	[10.5.11.16])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id x57MW042018564 for <dm-devel@listman.util.phx.redhat.com>;
	Fri, 7 Jun 2019 18:32:00 -0400
Received: by smtp.corp.redhat.com (Postfix)
	id 1A8B75C225; Fri,  7 Jun 2019 22:32:00 +0000 (UTC)
Delivered-To: dm-devel@redhat.com
Received: from mx1.redhat.com (ext-mx05.extmail.prod.ext.phx2.redhat.com
	[10.5.110.29])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id BEC515C220;
	Fri,  7 Jun 2019 22:31:55 +0000 (UTC)
Received: from linux.microsoft.com (linux.microsoft.com [13.77.154.182])
	by mx1.redhat.com (Postfix) with ESMTP id 712F737F41;
	Fri,  7 Jun 2019 22:31:53 +0000 (UTC)
Received: from
...
X-Greylist: Sender passed SPF test, ACL 242 matched, not delayed by
	...
	Fri, 07 Jun 2019 22:31:54 +0000 (UTC)
X-Greylist: inspected by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.29]);
	Fri, 07 Jun 2019 22:31:54 +0000 (UTC) for IP:'13.77.154.182'
...
Subject: [dm-devel] [RFC PATCH v3 0/1] Add dm verity root hash pkcs7 sig
	validation.
...
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.16
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.49]); Mon, 10 Jun 2019 07:59:53 +0000 (UTC)
