...
Received: from us-smtp-delivery-1.mimecast.com (us-smtp-delivery-1.mimecast.com [205.139.110.120])
	by mail.lfdr.de (Postfix) with ESMTP id 08C9C163D38
	for <lists+dm-devel@lfdr.de>; Wed, 19 Feb 2020 07:49:43 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1582094982;
	...
	bh=rU7VE2YNbvUjJk5lfaRTTREggPkuyA9UCbDB+bSVUDA=;
	b=iF77UbJzaA0pcUi4ph4c4aLkrtfenPAzXL4SpCxsKRjbyL47fReVPBj1QUa4vFqpMr+38D
	ZqlJP4sZCqErpKfjUBDlEzTKmPCS+p52PTVomFO+5bRbIbsl0vaJTQgsRYwHUYHK6Eu9qI
	vvVOYa373jSwUtIIY3osmxsLJOjW4Uo=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-332-lDTX7KYbMle711DBUiycJg-1; Wed, 19 Feb 2020 01:49:38 -0500
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.phx2.redhat.com [10.5.11.15])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 5A3961902EB5;
	Wed, 19 Feb 2020 06:49:33 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.20])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id EC56F5C13C;
	Wed, 19 Feb 2020 06:49:32 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 68DE51804744;
	Wed, 19 Feb 2020 06:49:32 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com
	[10.5.11.23])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 01J6n9tx015973 for <dm-devel@listman.util.phx.redhat.com>;
	Wed, 19 Feb 2020 01:49:09 -0500
Received: by smtp.corp.redhat.com (Postfix)
	id A251519757; Wed, 19 Feb 2020 06:49:09 +0000 (UTC)
Delivered-To: dm-devel@redhat.com
Received: from octiron.msp.redhat.com (octiron.msp.redhat.com [10.15.80.209])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 1182619756;
	Wed, 19 Feb 2020 06:49:07 +0000 (UTC)
Received: from octiron.msp.redhat.com (localhost.localdomain [127.0.0.1])
	by octiron.msp.redhat.com (8.14.9/8.14.9) with ESMTP id 01J6n5RA009981; 
	Wed, 19 Feb 2020 00:49:05 -0600
Received: (from bmarzins@localhost)
	by octiron.msp.redhat.com (8.14.9/8.14.9/Submit) id 01J6n573009980;
	Wed, 19 Feb 2020 00:49:05 -0600
From: Benjamin Marzinski <bmarzins@redhat.com>
To: Christophe Varoqui <christophe.varoqui@opensvc.com>
Date: Wed, 19 Feb 2020 00:48:37 -0600
Message-Id: <1582094920-9883-16-git-send-email-bmarzins@redhat.com>
...
Subject: [dm-devel] [PATCH v3 15/18] tests: add directio unit tests
...
X-MC-Unique: lDTX7KYbMle711DBUiycJg-1
...
index c9406e75..e9081e8f 100644
--- a/tests/Makefile
+++ b/tests/Makefile
@@ -12,7 +12,8 @@ CFLAGS += $(BIN_CFLAGS) -I$(multipathdir) -I$(mpathcmddir) \
